...
try:
    ...
    from tensorflow.compat.v1.distribute import cluster_resolver
...
def configure_tpu(FLAGS):
    if FLAGS.use_tpu:
        tpu_cluster = cluster_resolver.TPUClusterResolver(
    ...
    per_host_input = tpu.InputPipelineConfig.PER_HOST_V2
